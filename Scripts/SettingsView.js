var SettingsView = function (messages) {
    ...
    this.showForm = function (data) {
        ...
        $("#settingsallForm").html(SettingsView.templateForm(data));
...
SettingsView.template = Handlebars.compile($("#settingsall-tpl").html());
SettingsView.templateForm = Handlebars.compile($("#settingsallForm-tpl").html());